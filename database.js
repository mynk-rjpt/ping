...
class Database {
    ...
    connect() {
        // mongodb+srv://ping-database:<password>@pingcluster.ytrle.mongodb.net/myFirstDatabase?retryWrites=true&w=majority
        ...
        mongoose.connect("mongodb+srv://ping-database:ping-database@pingcluster.ytrle.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
        .then(() => {
